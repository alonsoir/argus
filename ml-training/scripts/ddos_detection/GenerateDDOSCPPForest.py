...
def extract_tree_structure(forest_model, feature_names):
    ...
    print("🌳 Extracting DDoS tree structures...")
...
def generate_ddos_cpp_header(forest_data, dataset_info, output_path: str):
    ...
    # ABRIR archivo y mantenerlo abierto para toda la función
...
""")
    ...
    print(f"✅ Generated DDoS header: {total_nodes} total nodes across {len(forest_data)} trees")
